...
import random
import torch
from egllie.datasets.eglol import eglol_withNE_dataset
from egllie.datasets.utils import ConcatDatasetCustom


class SequenceSDE(Dataset):

    def __init__(self, dataset_root, center_cropped_height, random_cropped_width, seq, is_train, voxel_grid_channel, is_split_event,
        ...
        self.dataset = eglol_withNE_dataset(
            dataset_root,
...
def get_eglol_withNE_dataset_vid(
    dataset_root,
    center_cropped_height,
    random_cropped_width,
    is_train,
